(function () {
  function mountLaiPhaserTown(options) {
    ...
    const world = { width: 941, height: 1672 };
    ...
    class LaiTownScene extends Phaser.Scene {
      ...
      preload() {
        this.load.image("townBg", "assets/lai-life-town-bg-fullscreen.png");
      ...
      drawTown() {
        ...
        this.addZoneObstacle(392, 698, 160, 118, "噴水池", 0x78b7c7, "circle");
        this.addBuilding(310, 183, 320, 210, "LAI 便當", 0xfff3d6, 0xffc84f);
        this.addBuilding(690, 178, 180, 150, "便當餐車", 0xfff8da, 0x7fb86f);
        this.addBuilding(260, 1058, 220, 210, "小菜園", 0xf3e2bd, 0x7fb86f);
        this.addBuilding(26, 468, 170, 170, "任務看板", 0xfff8da, 0xb87945);
        this.addBuilding(680, 728, 220, 205, "排行榜", 0xfff8da, 0xffc84f);
        this.addBuilding(685, 1036, 130, 160, "禮物郵箱", 0xf06a55, 0xffc84f);
        this.addBuilding(690, 508, 190, 160, "商城攤位", 0xfff8da, 0xb87945);
        this.addBuilding(60, 1238, 220, 210, "我的餐桌", 0xfff8da, 0x8b6f3c);
        this.addBuilding(70, 148, 230, 210, "企業團購", 0xe8eef6, 0x7fb86f);
        this.addBuilding(650, 1368, 230, 210, "巴士站", 0xf7d37c, 0x64a6df);
      }
      ...
      createPlayer() {
        const container = this.add.container(470, 868);
      ...
      createNpcs() {
        [
          ["店長阿萊", 420, 438, 0xf3a65d, "今天推薦雞腿排健康餐。", "orders"],
          ["菜園小幫手", 340, 1288, 0x7fb86f, "番茄和高麗菜快成熟了。", "garden"],
          ["好友小鎮民", 175, 938, 0xf0c16d, "要互送禮物嗎？", "friends"],
          ["活動主持人", 420, 748, 0xa7d9d0, "新活動正在中央廣場。", "events"],
          ["商城老闆", 760, 678, 0xb87945, "今天優惠券補貨。", "shop"],
          ["外送員", 770, 428, 0x64a6df, "訂單正在配送中。", "orders"]
      ...
      createInteractions() {
        this.interactions = [
          { id: "shop", x: 470, y: 428, radius: 78, title: "LAI\u4fbf\u7576\u5e97", text: "\u9032\u5165\u8a02\u8cfc\u8207\u4eca\u65e5\u9910\u76d2\u3002", button: "\u8a02\u4fbf\u7576", open: "orders" },
          { id: "truck", x: 770, y: 438, radius: 68, title: "\u4fbf\u7576\u9910\u8eca", text: "\u67e5\u770b\u4eca\u65e5\u63a8\u85a6\u9910\u76d2\u3002", button: "\u4eca\u65e5\u63a8\u85a6", open: "todayRecommendation" },
          { id: "task", x: 110, y: 608, radius: 66, title: "\u4efb\u52d9\u677f", text: "\u67e5\u770b\u6bcf\u65e5\u4efb\u52d9\u8207\u734e\u52f5\u3002", button: "\u4efb\u52d9\u4e2d\u5fc3", open: "tasks" },
          { id: "rank", x: 770, y: 888, radius: 72, title: "\u6392\u884c\u699c", text: "\u67e5\u770b\u4fbf\u7576\u738b\u8207\u597d\u53cb\u6392\u884c\u3002", button: "\u6392\u884c\u699c", open: "rankings" },
          { id: "garden", x: 345, y: 1208, radius: 78, title: "\u5c0f\u83dc\u5712", text: "\u6536\u6210\u98df\u6750\u4e26\u7d2f\u7a4d\u98df\u6750\u9ede\u6578\u3002", button: "\u9032\u5165\u83dc\u5712", open: "garden" },
          { id: "friends", x: 175, y: 938, radius: 68, title: "\u597d\u53cb\u5ee3\u5834", text: "\u627e\u597d\u53cb\u3001\u6253\u62db\u547c\u8207\u9001\u79ae\u3002", button: "\u597d\u53cb", open: "friends" },
          { id: "mail", x: 745, y: 1143, radius: 70, title: "\u79ae\u7269\u90f5\u7bb1", text: "\u67e5\u770b\u6536\u5230\u8207\u9001\u51fa\u7684\u79ae\u7269\u3002", button: "\u79ae\u7269", open: "gifts" },
          { id: "shopStand", x: 775, y: 638, radius: 72, title: "\u512a\u60e0\u5546\u57ce", text: "\u514c\u63db\u512a\u60e0\u5238\u3001\u52a0\u83dc\u5238\u8207\u88dd\u98fe\u54c1\u3002", button: "\u5546\u57ce", open: "shop" },
          { id: "table", x: 170, y: 1348, radius: 76, title: "\u6211\u7684\u9910\u684c", text: "\u4f48\u7f6e\u500b\u4eba\u9910\u684c\u7a7a\u9593\u3002", button: "\u6211\u7684\u9910\u684c", open: "table" },
          { id: "group", x: 180, y: 318, radius: 76, title: "\u4f01\u696d\u5718\u8cfc", text: "\u67e5\u770b\u516c\u53f8\u8207\u5718\u9ad4\u8a02\u9910\u3002", button: "\u4f01\u696d\u8a02\u9910", open: "groupOrder" },
          { id: "bus", x: 760, y: 1468, radius: 76, title: "\u63a2\u7d22\u51fa\u767c\u7ad9", text: "\u51fa\u9580\u901b\u901b\u9644\u8fd1\u6d3b\u52d5\u8207\u751f\u6d3b\u5708\u3002", button: "\u51fa\u9580\u901b\u901b", open: "explore" }
        ];
      }
